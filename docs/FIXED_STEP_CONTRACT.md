...
|----------------|----------------------|-------------------------|
| **Platformer** (no body or kinematic follower) | `World` platformer controller integrates `Transform`; may push position into body if present | `syncPhysicsToEntities` **skips** platformer entities |
