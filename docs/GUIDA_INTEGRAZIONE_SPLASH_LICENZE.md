...
Ritardare il rendering della UI principale (`MenuBar`, `LeftSidebar` / `ProjectExplorerPanel`, ecc.) finché l’animazione della splash non è terminata; in background, verifica licenza.
