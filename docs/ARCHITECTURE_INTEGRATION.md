...
**Vedi anche:** [`LOGIC_BOARD_SPEC.md`](LOGIC_BOARD_SPEC.md) — **Parte I** (termini) · **Parte III** (Logic Board: JSON, compilatore, UI) · [`LOGIC_BOARD_CONDITIONAL_DESIGN.md`](LOGIC_BOARD_CONDITIONAL_DESIGN.md) (OR/ELSE, branch) · [`ARCHITETTURA_TECNICA_ENGINE_2D.md`](ARCHITETTURA_TECNICA_ENGINE_2D.md) — §8–11.
