...
public:
    ...
    /**
     * Merges renderer-owned simulation inputs with host editor state, then syncs.
     * Sole entry path for presentation input before commit/refresh.
     */
    void sync_from_renderer(const PresentationStateInputs& renderInputs,
