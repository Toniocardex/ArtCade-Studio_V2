...
import type { ImageAsset, ImagePointDef, ProjectDoc, TilesetAsset } from '../types'
import {
  isBackspaceKey,
  isInsidePanel,
...
function categoryShowsEmpty(
  ...
  if (cat === 'ALL') return !hasImages && !hasTilesets
...
export default function AssetBrowserPanel() {
  ...
  const showEmpty = categoryShowsEmpty(cat, project, hasImages, hasTilesets)
