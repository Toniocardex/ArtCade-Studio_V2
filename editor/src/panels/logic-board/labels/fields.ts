...
const FIELD_LABELS: Record<string, string> = {
  ...
  'trigger:onAnimationFrame:frameIndex': 'Frame number',
  'trigger:onAnimationLoop:clipName': 'Animation name',
  'trigger:onAnimationChange:clipName': 'Animation name',
  ...
  'trigger:onMessage:messageName': 'Event name',
  'action:emitEvent:name': 'Event name',
  'trigger:onDialogMessage:messageName': 'Message name',
  ...
  'action:spawnEntity:velocityX': 'Launch velocity X',
  'action:spawnEntity:velocityY': 'Launch velocity Y',
  'action:spawnAtEntity:velocityX': 'Launch velocity X',
  'action:spawnAtEntity:velocityY': 'Launch velocity Y',
  'action:spawnEntityAtPointer:velocityX': 'Launch velocity X',
  'action:spawnEntityAtPointer:velocityY': 'Launch velocity Y',
  'action:setScale:scaleX': 'Scale X',
  'action:setScale:scaleY': 'Scale Y',
  ...
  'action:setPlatformerMaxSpeed:speed': 'Max speed',
  'action:setPlatformerJumpForce:force': 'Jump force',
  'action:setPlatformerGravity:gravity': 'Gravity',
  'action:setTopDownMaxSpeed:speed': 'Max speed',
  'action:setTopDownAcceleration:acceleration': 'Acceleration',
  'action:setTopDownFriction:friction': 'Friction',
  'action:setTopDownFourDirections:enabled': 'Four directions',
