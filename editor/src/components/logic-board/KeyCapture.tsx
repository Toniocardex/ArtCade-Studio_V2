    ...
    <>
      ...
      {open ? (
        <dialog
          ...
          className="artcade-dialog fixed inset-0 z-[200] m-0 flex h-full max-h-full w-full max-w-full items-center justify-center border-0 bg-transparent p-6 backdrop:bg-black/50"
        >
