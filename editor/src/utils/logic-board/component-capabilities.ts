...
const CAPABILITIES: CapabilityDef[] = [
  ...
  { kind: 'action', type: 'setMagnetEnabled', feature: 'magneticItem', label: 'Magnetic Item' },
  { kind: 'action', type: 'setMagnetTargetTag', feature: 'magneticItem', label: 'Magnetic Item' },
  { kind: 'action', type: 'setMagnetRadius', feature: 'magneticItem', label: 'Magnetic Item' },
  { kind: 'action', type: 'setMagnetPullSpeed', feature: 'magneticItem', label: 'Magnetic Item' },
