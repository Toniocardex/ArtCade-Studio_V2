...
/**
 * Browser pointer sample tagged with the presentation revision active when captured.
 * Mirrors C++ {@link SurfacePointerEvent} (ADR Phase 5).
 */
...
/**
 * Captures a pointer sample and the committed presentation revision at event time.
